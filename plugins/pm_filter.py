...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == "private":
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('കളിക്കുന്നോടാ.#@&')
            else:
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 Search', switch_inline_query_current_chat='BQADBQADjAMAArkjSFT_BIHEYYfcqRYE'),
        ...
        await query.answer('കളിക്കുന്നോടാ.#@&')
    elif query.data == "help":
        buttons = [[
            InlineKeyboardButton('🤖 Updates', url='https://t.me/IET_UPDATES'),
            InlineKeyboardButton('📍 Support', url='https://t.me/IET_Support')
        ], [
            InlineKeyboardButton('👩‍🏭 മൊയ്ലാളി', url='https://t.me/IET_Owner'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Tʀᴀɴsʟᴀᴛᴇ', callback_data='trslt'),
        ], [
